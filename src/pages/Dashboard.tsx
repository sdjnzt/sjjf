...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    const alerts: SystemAlert[] = [
      ...
      },
      {
        ...
        type: 'success',
        title: '系统检测完成',
        message: '所有数据机房设备健康检查已完成，系统运行正常',
        time: '14:08',
        read: true
      },
      {
  ...
  const handleExportData = () => {
    ...
    link.href = url;
    link.download = `数据机房监控数据-${new Date().toISOString().split('T')[0]}.json`;
    link.click();
    URL.revokeObjectURL(url);
    
    Modal.success({
      title: '导出成功',
      content: '数据机房监控数据已成功导出到本地文件',
    });
  };
        ...
        <div style={{ maxHeight: '400px', overflow: 'auto' }}>
          <Timeline
            items={[
              ...
              {
                children: '2025-07-15 14:20:32 - 数据机房系统健康检查完成',
                color: 'blue'
              },
              {
              ...
              {
                children: '2025-07-15 14:05:33 - 数据机房监控系统启动完成',
                color: 'blue'
              }
            ]}
          />
      ...
      <div style={{ marginBottom: '24px' }}>
          <Alert
            ...
            <Flex justify="space-between" align="center">
                <Space size="large">
                  <Space>
                  <Text strong style={{ color: '#52c41a' }}>数据机房系统运行正常</Text>
                  </Space>
              ...
              <Progress 
                ...
                format={() => 
                  <div style={{ textAlign: 'center' }}>
                    ...
                    <div style={{ fontSize: '12px', color: '#8c8c8c' }}>数据机房系统健康度</div>
                  </div>
                }
              />
            </div>
